...
<head>
    <meta charset="utf-8">
    <title>Laporan Radiography Work Permit (RWP)</title>
    <style>
...
<body>
    ...
    <table style="width:100%; margin-bottom:3px;">
        <tr>
            <td align="center">
                <span style="font-size:12px; font-weight:bold; color:#1B5E20;">LAPORAN RADIOGRAPHY WORK PERMIT (RWP)</span>
            </td>
        </tr>
    </table>
    ...
    <table style="width:100%; font-size:7px; margin-bottom:1px;">
        <tr>
            <td style="width:40%;"><b>No. Dokumen:</b> FM-BSHS-19/08</td>
    ...
    <table style="width:100%; border:1px solid #2E7D32; font-size:7px;">
        <thead>
            <tr style="background-color:#2E7D32; color:#fff;">
                ...
                <th style="border:1px solid #1B5E20; padding:3px 2px; text-align:center; width:16%;">Peralatan</th>
                <th style="border:1px solid #1B5E20; padding:3px 2px; text-align:center; width:12%;">Area/Ruang</th>
                <th style="border:1px solid #1B5E20; padding:3px 2px; text-align:center; width:12%;">Tipe Sumber</th>
                <th style="border:1px solid #1B5E20; padding:3px 2px; text-align:center; width:6%;">Status</th>
                <th style="border:1px solid #1B5E20; padding:3px 2px; text-align:center; width:16%;">Catatan</th>
        ...
        <tbody>
            ...
            <tr style="background-color:{{ $bg }};">
                ...
                <td style="border:1px solid #ccc;">{{ $item->area ?? '-' }}</td>
                <td style="border:1px solid #ccc;">{{ $item->tipe_sumber ?? '-' }}</td>
            ...
            @empty
            <tr>
                <td colspan="9" style="border:1px solid #ccc; text-align:center; padding:10px; color:#888;">Tidak ada data RWP</td>
            </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table style="width:100%; margin-top:2px; border-top:1px solid #ddd;">
        <tr>
            <td align="center" style="font-size:6px; color:#999; padding-top:2px;">
                Total: {{ count($data) }} data RWP | Dicetak otomatis oleh Sistem HSE - PT. Industri Nabati Lestari
            </td>
        </tr>
    </table>
</body>
