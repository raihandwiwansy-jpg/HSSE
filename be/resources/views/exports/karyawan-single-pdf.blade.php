...
<head>
    <meta charset="utf-8">
    <title>Detail Karyawan #{{ $data->id }}</title>
    <style>
        @page { margin: 20px; }
...
<body>
    <div class="container">
        ...
        <hr>
        <div class="title">DETAIL DATA KARYAWAN</div>
        <table class="info-table">
            <tr>
                <td class="left">
                    <strong>No. Dokumen:</strong> FM-BSHS-19/KAR-D &nbsp;|&nbsp; <strong>No. Revisi:</strong> 00
                </td>
                <td class="right">
        ...
        <div style="margin-top: 15px;">
            ...
            <div class="info-row">
                ...
                <div class="info-value">: {{ $data->jabatan }}</div>
            </div>
            <div class="info-row">
