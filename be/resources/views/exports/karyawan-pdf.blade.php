...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        table.data th { background-color: #2E7D32; color: white; padding: 5px 3px; text-align: center; font-weight: bold; font-size: 8px; border: 1px solid #1B5E20; }
        table.data td { padding: 3px; border: 1px solid #ccc; font-size: 8px; vertical-align: top; }
...
<body>
    <div class="container">
        ...
        <table class="info-table">
            <tr>
                <td class="left">
                    <strong>No. Dokumen:</strong> FM-BSHS-19/KAR &nbsp;|&nbsp; <strong>No. Revisi:</strong> 00
                </td>
                <td class="right">
        ...
        <table class="data" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="6" class="text-center" style="padding:15px; color:#888;">Tidak ada data karyawan</td>
                </tr>
                @endforelse
            </tbody>
        </table>
        <div class="footer-text">
            Total: {{ count($data) }} data karyawan | Dicetak otomatis oleh Sistem HSE - PT. Industri Nabati Lestari
        </div>
    </div>
</body>
</html>
