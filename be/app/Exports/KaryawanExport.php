...
class KaryawanExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithTitle, WithEvents
{
    protected $search;
    ...
    {
        return ['No', 'NIK', 'Nama', 'Jabatan', 'Departemen', 'No. HP'];
    }
    ...
    public function registerEvents(): array
    {
        return [
            BeforeSheet::class => function (BeforeSheet $event) {
                ...
                $sheet->setCellValue('A3', 'No. Dokumen: FM-BSHS-19/KAR | No. Revisi: 00 | Tgl. Cetak: ' . now()->format('d/m/Y H:i'));
